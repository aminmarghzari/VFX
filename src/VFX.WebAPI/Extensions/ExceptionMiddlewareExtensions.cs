...
/// <summary>
/// Extension class for exception handling at the middleware level.
/// This class allows the application to identify different exceptions and
/// return appropriate HTTP responses based on the error type.
/// </summary>
