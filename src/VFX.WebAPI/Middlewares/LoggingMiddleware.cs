...
using VFX.Application.Utilities;

namespace VFX.WebAPI.Middlewares;

// Middleware to log the incoming request and outgoing response for debugging and monitoring
public class LoggingMiddleware(RequestDelegate next, ILoggerFactory loggerFactory, AppSettings appSettings)
{
    ...
    // Executes the actual logging of the request data.
